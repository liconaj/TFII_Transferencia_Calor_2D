...
% Refrigerante (propylen glycol)
% punto de ebullición: 188.2°C
rfg = struct();
rfg.p = 1036; %(kg/m3) densidad
rfg.v = 0.4e-6; %(m2/s) viscosidad cinemática
rfg.cp = 2470; %(J/kg°C) calor especifico
rfg.k = 0.34; %(W/m°C) conductividad térmica a 20°C
